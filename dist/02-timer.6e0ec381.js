...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js":[function(require,module,exports) {
var define;
...
function checkDate(date) {
  ...
  if (date < now) {
    _notiflix.default.Report.failure("Please choose a date in the future");
...
startBtn.addEventListener("click", () => {
  const timerId = setInterval(() => {
    ...
    seconds.innerHTML = addLeadingZero(res.seconds); // console.log(res);
  }, 1000);

  _notiflix.default.Notify.success();
});
